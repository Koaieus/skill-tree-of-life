...
## (#779) — the multiplier blade_damage saturates toward as contact speed
## grows. Floored at 1, never a penalty. Vertices only: under ADR 0005 an edge
## carries no damage for this to scale.
