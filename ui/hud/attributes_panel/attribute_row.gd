...
## the chip shows the difference of THESE, not of the raw floats: a
## fractional delta that would truncate to "+0" never fires the chip, and
## 5.9 → 6.1 (displayed "5" → "6") pops "+1", not "+0".
