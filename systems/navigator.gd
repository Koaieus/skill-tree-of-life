...
func _on_tree_graph_nodes_connected(from_node: GraphNode, to_node: GraphNode) -> void:
...
func _on_tree_graph_nodes_disconnected(from_node: GraphNode, to_node: GraphNode) -> void:
	#if from_node is TreeNode and to_node is TreeNode:
