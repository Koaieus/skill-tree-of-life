...
## no book at all.
const _NOT_LOOTABLE := ["spark", "lightning_bolt", "dazzle", "sunder", "venom", "hex"]  # dazzle/sunder/venom/hex: debug-book appliers (#873/#877/#874/#965); loot placement is the owner's (#868)
